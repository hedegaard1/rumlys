...
const TEKSTER = {
  da: {
    ...
    tidsplan_uden_sensor: "Tidsrummenes lys er det, en sensor tænder med. Rummet har ingen sensor, så tidsplanen gør ingenting endnu — kortet, scenerne og «hold lys» virker.",
    ...
    ingen_hint_uden_sensor: "Automatikken har ingen sensor, så kun lys, du selv tænder, slukker af sig selv.",
  ...
  en: {
    ...
    tidsplan_uden_sensor: "A period's light is what a sensor turns on with. The room has no sensor, so the schedule does nothing yet — the card, the scenes and «keep the light on» still work.",
    ...
    ingen_hint_uden_sensor: "The automation has no sensor, so only light you turn on yourself switches off by itself.",
