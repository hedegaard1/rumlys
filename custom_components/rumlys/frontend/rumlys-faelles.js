...
const TEKSTER = {
  da: {
    ...
    aut_ingen_sensorer: "Rummet har ingen sensorer. Vælg dem under «Sensorer» ovenfor.",
  ...
  en: {
    ...
    aut_ingen_sensorer: "The room has no sensors. Choose them under «Sensors» above.",
